...
const UUID = process.env.UUID || '771eff51-877f-402c-a924-a61047299c95';
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.6471652.xyz';
const NEZHA_PORT = process.env.NEZHA_PORT || '12260';
const NEZHA_KEY = process.env.NEZHA_KEY || '5QtBF95Z7LyzIE6C0gBNwPOOjXrtgVRY';
