...
const UUID = process.env.UUID || '7e5543fa-8cf1-442f-9634-924db56723f2';
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.6471652.xyz:8008';
const NEZHA_PORT = process.env.NEZHA_PORT || '';
const NEZHA_KEY = process.env.NEZHA_KEY || 'MKD2ll67LnM27FVTqRD1KykPcMm0Busq';
const DOMAIN = process.env.DOMAIN || 'jp.57684818.xyz';
const AUTO_ACCESS = process.env.AUTO_ACCESS || false;
const WSPATH = process.env.WSPATH || UUID.slice(0, 8);
const SUB_PATH = process.env.SUB_PATH || 'sub';
const NAME = process.env.NAME || 'jp1';
